...
var AppComponent = /** @class */ (function () {
    function AppComponent(todoServices) {
        var _this = this;
        this.todoServices = todoServices;
        this.title = 'ToDoList';
        this.todosArray = [];
        this.todoServices.getTodos().then(function (td) {
            _this.todosArray = td;
            console.log(_this.todosArray);
        });
    }
    // 
    AppComponent.prototype.addItem = function ($event) {
        var _this = this;
        this.todoServices.createTodo($event).then(function (res) {
            var newItem = {
                id: res.id,
                status: false,
                text: res['body'],
            ...
            _this.todosArray.unshift(newItem);
        });
    };
    // 
    AppComponent.prototype.updateItem = function ($event) {
        console.log($event);
    };
    // 
    AppComponent.prototype.deleteItem = function ($event) {
        var _this = this;
        this.todoServices.deleteTodo($event).then(function (res) {
            if (res == 200) {
                var index = _this.todosArray.findIndex(function (el) { return el.id === $event; });
                _this.todosArray.splice(index, 1);
            }
        });
    };
...
var ItemComponent = /** @class */ (function () {
    function ItemComponent(modalService) {
    ...
    // 
    ItemComponent.prototype.open = function (content) {
        var modalRef = this.modalService.open(_modal_modal_edit_component__WEBPACK_IMPORTED_MODULE_3__["NgbdModalContent"]);
...
var ListComponent = /** @class */ (function () {
    ...
    ListComponent.prototype.delItem = function (id) {
...
var NgbdModalContent = /** @class */ (function () {
    ...
    NgbdModalContent.prototype.saveEdited = function () {
...
var TodoService = /** @class */ (function () {
    ...
    TodoService.prototype.getTodos = function (limit) {
        if (limit === void 0) { limit = 10; }
        return fetch("https://jsonplaceholder.typicode.com/posts?_limit=" + limit)
            .then(function (r) { return r.json(); })
            .then(function (todos) { return todos.map(function (td) {
            return {
                id: td.id,
                status: td.completed,
                text: td.body,
